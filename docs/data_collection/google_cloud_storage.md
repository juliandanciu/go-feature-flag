...
Check this [complete example](https://github.com/juliandanciu/go-feature-flag/tree/main/examples/data_export_googlecloudstorage) to see how to export the data in S3.
...
Check the [godoc for full details](https://pkg.go.dev/github.com/juliandanciu/go-feature-flag/exporter/gcstorageexporter).
